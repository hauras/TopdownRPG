...
ATopdownAIController::ATopdownAIController(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer.SetDefaultSubobjectClass<UCrowdFollowingComponent>("PathFollowingComponent"))
{
	...
	EnemyPerceptionComponent->OnTargetPerceptionUpdated.AddUniqueDynamic(this,&ThisClass::ATopdownAIController::OnEnemyPerceptionUpdated);
...
ETeamAttitude::Type ATopdownAIController::GetTeamAttitudeTowards(const AActor& Other) const
{
	...
	const IGenericTeamAgentInterface* OtherTeam = Cast<IGenericTeamAgentInterface>(PawnToCheck ->GetController());
...
void ATopdownAIController::OnEnemyPerceptionUpdated(AActor* Actor, FAIStimulus Stimulus)
{
